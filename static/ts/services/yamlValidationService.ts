...
import type { YAMLSchema, YAMLPropertySchema, YAMLValidationResult } from '../types/yaml';

// Import js-yaml from CDN
declare const yaml: { load: typeof load };

/**
 * Service for validating YAML content against a schema
 */
class YAMLValidationService {
    private schema: YAMLSchema | null = null;
     ...
     */
    async loadSchema(): Promise<YAMLSchema> {
        ...
        try {
            ...
            this.schema = yaml.load(schemaText) as YAMLSchema;
            return this.schema;
        } catch (error) {
     ...
     */
    validateAgainstSchema(data: any, schema: YAMLSchema | null = null): YAMLValidationResult {
