import type { ApiResponse, ADLValidationResult } from '../types/services.js';
...
class ADLService {
     ...
     */
    async validateYaml(yamlText: string): Promise<ApiResponse<ADLValidationResult>> {
        try {
     ...
     */
    async getValue(path: string): Promise<ApiResponse<{path: string; value: any}>> {
        try {
     ...
     */
    async listCommands(): Promise<ApiResponse<{commands: string[]}>> {
        try {
     ...
     */
    async listOptions(): Promise<ApiResponse<{options: any}>> {
        try {
     ...
     */
    async listDecorators(): Promise<ApiResponse<{decorators: any}>> {
        try {
