import type { Setting, ApiResponse, EmailTestResult, OpenAIModel } from '../types/services.js';
...
class SettingService {
     ...
     */
    async getDecryptedValue(settingId: number): Promise<ApiResponse<string>> {
        try {
     ...
     */
    async updateSetting(settingId: number, data: Partial<Setting>): Promise<ApiResponse<Setting>> {
        try {
     ...
     */
    async loadOpenAIModels(): Promise<ApiResponse<OpenAIModel[]>> {
        try {
     ...
     */
    async createSetting(data: Omit<Setting, 'id'>): Promise<ApiResponse<Setting>> {
        try {
            const response = await fetch('/api/v1/settings/', {
                method: 'POST',
                headers: this.getHeaders(),
     ...
     */
    async updateSettings(data: Record<string, any>): Promise<ApiResponse<void>> {
        try {
