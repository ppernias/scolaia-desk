...
class ChatWebSocket {
    private elements = {
        form: document.getElementById('wsChatForm') as HTMLFormElement,
        input: document.getElementById('wsMessageInput') as HTMLInputElement,
        messages: document.getElementById('wsChatMessages') as HTMLDivElement,
        sendButton: document.getElementById('wsSendButton') as HTMLButtonElement,
    ...
    private selectedFiles: File[] = []; // Se cambió de selectedFile a selectedFiles como arreglo para admitir varias cargas de archivos
    ...
    private async sendWelcomeMessage(): Promise<void> {
        ...
        const waitForConnection = (callback: Function) => {
            if (this.isConnected) {
                callback();
            } else {
     ...
     */
    private async extractTextFromFiles(): Promise<void> {
        if (!this.selectedFiles.length) {
            return;
        }
