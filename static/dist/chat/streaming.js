...
class ChatStreaming {
    constructor() {
        this.elements = {
            form: document.getElementById('streamChatForm'),
            input: document.getElementById('streamMessageInput'),
            messages: document.getElementById('streamChatMessages'),
            sendButton: document.getElementById('streamSendButton')
        };
     ...
     */
    async streamResponse(message, responseElement) {
        var _a;
